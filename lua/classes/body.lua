Class "Body"
	...
	function Body:setRoundRect(w, h, a, b, points, corners)
		...
		t = not corners.d and getEllipsePoints(-w/2 + a, h/2 - b, a, b, points/4, pi * 1.5, pi) or {-w/2, h/2}
		table.move(t, 1, #t, #verts + 1, verts)
		t = not corners.a and getEllipsePoints(-w/2 + a, - h/2 + b, a, b, points/4, pi, pi/2) or {-w/2, -h/2}
		table.move(t, 1, #t, #verts + 1, verts)
		for i = #verts, 1, -2 do

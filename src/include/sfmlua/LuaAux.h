...
namespace LuaAux
{
    ...
    std::vector<std::string> splitLuaErrorPath(const std::string& error);

    void newClass(lua_State* L, const luaL_Reg* methods, const luaL_Reg* metamethods,
                          const std::string& className, lua_CFunction callfunction, bool setGlobal = true);

    void newGlobal(lua_State* L, const std::string& globalName, lua_CFunction var);
    void newGlobal(lua_State* L, const std::string& globalName, unsigned var);
    void newGlobal(lua_State* L, const std::string& globalName, int var);
    void newGlobal(lua_State* L, const std::string& globalName, float var);
    void newGlobal(lua_State* L, const std::string& globalName, const std::string& var);
    void newGlobal(lua_State* L, const std::string& globalName, void* var);
    void newGlobal(lua_State* L, const std::string& tableName, const std::string& globalName, lua_CFunction var);
    void newGlobal(lua_State* L, const std::string& tableName, const std::string& globalName, unsigned var);
    void newGlobal(lua_State* L, const std::string& tableName, const std::string& globalName, int var);
    void newGlobal(lua_State* L, const std::string& tableName, const std::string& globalName, float var);
    void newGlobal(lua_State* L, const std::string& tableName, const std::string& globalName, const std::string& var);
    void newGlobal(lua_State* L, const std::string& tableName, const std::string& globalName, void* var);
    void setGlobal(lua_State* L, const std::string& tableName, const std::string& globalName);

    LuaData getTableField(lua_State* L, int tableIndex, const std::string& fieldName);
};

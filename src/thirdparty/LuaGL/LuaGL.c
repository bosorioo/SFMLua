...
//Specify vertices or rectangles:
   ...
   FUN_vD2  (glVertex2f)   //void glVertex2{sifd}{v} (TYPE x, TYPE y);
   FUN_vD3  (glVertex3f)   //void glVertex3{sifd}{v} (TYPE x, TYPE y, TYPE z);
   FUN_vD4  (glVertex4f)   //void glVertex4{sifd}{v} (TYPE x, TYPE y, TYPE z, TYPE w);
   ...
   FUN_vD3  (glColor3f)          //void glColor3{bsifd ubusui}{v} (TYPE red, TYPE green, TYPE blue);
   FUN_vD4  (glColor4f)          //void glColor4{bsifd ubusui}{v} (TYPE red, TYPE green, TYPE blue, TYPE alpha);
   ...
   FUN_vD   (glTexCoord1f)    // void glTexCoord1{sifd}{v} (TYPE s);
   FUN_vD2  (glTexCoord2f)    // void glTexCoord2{sifd}{v} (TYPE s, TYPE t);
   FUN_vD3  (glTexCoord3f)    // void glTexCoord3{sifd}{v} (TYPE s, TYPE t, TYPE r);
   FUN_vD4  (glTexCoord4f)    // void glTexCoord4{sifd}{v} (TYPE s, TYPE t, TYPE r, TYPE q);
   ...
   /*w32*/FUN_vE4  (glBlendFuncSeparate) //void glBlendFunc (GLenum sfactor, GLenum dfactor);
...
void lua_opengl(lua_State *L)
{
    ...
    {
        lua_pushfstring(L, "glewInit error: %s", glewGetErrorString(err));
        lua_setglobal(L, "glewError");
    }
}
